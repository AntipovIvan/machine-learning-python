...
classLabel = ck.CTkLabel(window, height=40, width=120,
                         text_font=('Arial', 20), text_color="black", padx=10)
classLabel.place(x=10, y=1)
classLabel.configure(text='STAGE')

counterLabel = ck.CTkLabel(
    window, height=40, width=120, text_font=('Arial', 20), text_color="black", padx=10)
...
classBox = ck.CTkLabel(window, height=40, width=120,
                       text_font=('Arial', 20), text_color="black", fg_color="blue")
